...
\begin{document}
    ...
    \begin{abstract}
        Dokument zawiera specyfikację funkcjonalną oraz implementacyjną dotyczącą projektu \textsl{GridGraph} oraz opis testów programu.
    \end{abstract}
    ...
    \begin{itemize}
        ...
        \begin{description}
            \item[Typ:] Liczba rzeczywista
            \item[Zakres:] $<$\console{edge\_weight\_min}, 1$>$
